...
**Before drafting options (every section and outside voice):** Name the one
behavioral policy, implementation choice, or verification-depth decision the answer authorizes. Inventory
the other policies; keep their approved values fixed or leave them explicitly
