...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'autoplan-chain-pty':          ['bin/gstack-skill-start', 'autoplan/**', 'plan-ceo-review/**', 'plan-design-review/**', 'plan-eng-review/**', 'plan-devex-review/**', 'test/fixtures/plans/ui-heavy-feature.md', 'test/helpers/claude-pty-runner.ts', 'test/helpers/autoplan-phase-order.ts', 'test/helpers/autoplan-fixture.ts', 'test/autoplan-fixture.test.ts', 'test/autoplan-phase-observation.test.ts', 'test/skill-e2e-autoplan-chain.test.ts'],
