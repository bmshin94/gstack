...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'autoplan-chain-pty':          ['test/autoplan-phase-order.test.ts', 'scripts/resolvers/design-doc-discovery.ts', 'bin/gstack-skill-start', 'bin/gstack-paths', 'test/gstack-paths.test.ts', 'autoplan/**', 'plan-ceo-review/**', 'plan-design-review/**', 'plan-eng-review/**', 'plan-devex-review/**', 'test/fixtures/plans/ui-heavy-feature.md', 'test/fixtures/plans/ui-heavy-feature-design.md', 'test/fixtures/plans/autoplan-password-visibility.md', 'test/fixtures/plans/autoplan-password-visibility-design.md', 'test/helpers/claude-pty-runner.ts', 'test/pty-workspace-trust.test.ts', 'test/fixtures/pty-companion-cli.ts', 'test/helpers/hermetic-skill-runtime.ts', 'test/hermetic-skill-runtime.test.ts', 'lib/fs-atomic.ts', 'test/helpers/autoplan-phase-order.ts', 'test/helpers/autoplan-fixture.ts', 'test/fixtures/autoplan-existing-app/**', 'test/autoplan-fixture.test.ts', 'test/autoplan-phase-observation.test.ts', 'test/skill-e2e-autoplan-chain.test.ts', 'test/helpers/owned-claude-transcript.ts', 'test/helpers/pty-current-screen.ts', 'test/pty-current-screen.test.ts', 'test/fixtures/native-viewport.ts', 'test/helpers/plan-skill-questions.ts', 'test/fixtures/bash-directory-permission.json', 'test/plan-skill-read-permission.test.ts', 'test/fixtures/read-permission.json', 'test/plan-skill-questions.test.ts', 'test/helpers/plan-skill-question-events.ts', 'test/plan-skill-question-events.test.ts', 'test/helpers/plan-skill-question-hook-scope.ts', 'test/plan-skill-question-hook-scope.test.ts', 'scripts/resolvers/testing.ts', 'scripts/resolvers/review.ts', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'test/autoplan-permission-viewport.test.ts', 'test/plan-review-cases.test.ts'],
