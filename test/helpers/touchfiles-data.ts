...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  'plan-ceo-mode-routing':       ['plan-ceo-review/**', 'scripts/resolvers/preamble/generate-ask-user-format.ts', 'scripts/resolvers/preamble.ts', 'test/helpers/claude-pty-runner.ts', 'test/helpers/hermetic-skill-runtime.ts', 'test/hermetic-skill-runtime.test.ts', 'lib/fs-atomic.ts', 'test/skill-e2e-plan-ceo-mode-routing.test.ts', 'test/helpers/claude-pty-runner.unit.test.ts', 'test/helpers/plan-skill-questions.ts', 'test/plan-skill-questions.test.ts', 'test/helpers/plan-skill-question-events.ts', 'test/plan-skill-question-events.test.ts', 'test/helpers/plan-skill-question-hook-scope.ts', 'test/plan-skill-question-hook-scope.test.ts', 'test/helpers/owned-claude-transcript.ts', 'test/helpers/plan-skill-mode-navigation.ts', 'test/plan-skill-mode-navigation.test.ts', 'test/fixtures/plan-skill-mode-navigation.ts', 'test/helpers/pty-current-screen.ts', 'test/pty-current-screen.test.ts'],
