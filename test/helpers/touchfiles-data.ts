...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Autoplan
  'autoplan-dual-voice': ['autoplan/**', 'plan-ceo-review/**', 'plan-eng-review/**', 'plan-design-review/**', 'plan-devex-review/**', 'codex/**', 'bin/gstack-codex-probe', 'scripts/resolvers/review.ts', 'scripts/resolvers/design.ts', 'test/skill-e2e-autoplan-dual-voice.test.ts', 'scripts/resolvers/testing.ts'],
