...
const planCeo5Findings = (planPath: string) => [
  ...
  "An empty order list is valid. A missing referenced order instead quarantines the",
  "event, logs its ID and returns 200 without a payment mutation or email; it does not",
  "write a processed-event receipt. DatabaseConnectionError, StatementTimeoutError",
